(function(){
	...
	*/
	operationSignal = '-';
	var subtraction = calculadora( operationSignal );
	if( subtraction ) {
		number1 = 10;
		number2 = 15;
	...
	operationSignal = '*';
	var multiplication = calculadora( operationSignal );
	if( multiplication ) {
		number1 = 10;
		number2 = 15;
	...
	operationSignal = '/';
	var division = calculadora( operationSignal );
	if( division ) {
		number1 = 10;
		number2 = 15;
	...
	operationSignal = '%';
	var mod = calculadora( operationSignal );
	if( mod ) {
		number1 = 10;
		number2 = 15;
	...
	*/
	operationSignal = '3';
	var erro = calculadora( operationSignal );
	if( erro ) {
		number1 = 10;
		number2 = 15;
		console.log( showOperationMessage( number1, operationSignal, number2 ), erro( number1, number2 ) );
	}
	else{
		console.log( showErrorMessage(operationSignal) )
	}
