(function(){
	...
	*/
	...
	var justNumbersRegex = function(text){
		return text.match(/(^\d+)/gm);
	}
	...
	*/
	...
	console.log(justNumbersRegex(text));
	...
	*/
	...
	var numbersAtTheEnd = function(text){
		return text.match(/(\d+$)/gm);
	};
	...
	*/
	...
	console.log( numbersAtTheEnd(otherText) );
