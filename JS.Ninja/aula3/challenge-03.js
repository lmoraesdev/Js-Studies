...
console.log(pessoa.andar(8))
console.log(pessoa.andar(9))
...
pessoa.apresentacao = function(){
	...
	return `Olá, eu sou ${artigo} ${pessoa.nome} ${pessoa.sobrenome}, tenho ${pessoa.idade} ${singular}, ${pessoa.altura}, meu peso é ${pessoa.peso} e, só hoje, eu já caminhei ${pessoa.caminhouQuantosMetros} metros!`
}
